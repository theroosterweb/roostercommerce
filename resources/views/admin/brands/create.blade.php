                            ...
                            <div class="card-body">
                                <form action="" method="post" id="brandForm" name="brandForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" id="brandname" aria-describedby="brandHelp">
                                        <p></p>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="slug" class="form-control" id="brandslug" aria-describedby="brandSlugHelp" readonly>
                                        <p></p>
