        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-12 d-flex align-items-stretch">
                    <div class="card w-100">
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-6">
                                    <small> CATEGORIAS / LISTA  </small>
                                </div>
                                <div class="col-6">
                                    <div class="ms-auto" style="width: 150px;">
                                        <a href="{{ route('admin.categories.create')}}">
                                            <button class="btn btn-sm btn-info "><i class="ti ti-circle-plus"></i> NUEVA CATEGORIA </button>
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12 d-flex align-items-stretch">
                    <div class="card w-100">
                        <div class="card-body p-4">
                            <h5 class="card-title fw-semibold mb-4">Lista Categorias</h5>
                                        ...
                                        @if ($categories->isNotEmpty())
                                            @foreach ( $categories as $category )
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="border-bottom-0"> <h6 class="fw-semibold mb-0">{{$category->name}}</h6> </td>
                                                    <td class="border-bottom-0"><h6 class="fw-semibold mb-0">{{$category->slug}}</h6></td>
