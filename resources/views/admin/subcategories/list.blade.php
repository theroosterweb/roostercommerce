        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-12 d-flex align-items-stretch">
                    <div class="card w-100">
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-6">
                                    <small> SUBCATEGORIAS / LISTA  </small>
                                </div>
                                <div class="col-6">
                                    <div class="ms-auto" style="width: 150px;">
                                        <a href="{{ route('admin.subcategories.create')}}">
                                            <button class="btn btn-sm btn-info "><i class="ti ti-circle-plus"></i> NUEVA SUBCATEGORIA </button>
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12 d-flex align-items-stretch">
                    <div class="card w-100">
                        <div class="card-body p-4">
                            <h5 class="card-title fw-semibold mb-4">Lista Sub Categorias</h5>
                                ...
                                <table class="table text-nowrap mb-0 align-middle">
                                    ...
                                    <thead class="text-dark fs-4">
                                        <tr>
                                            ...
                                            <th class="border-bottom-0">
                                                <h6 class="fw-semibold mb-0">Categoria Padre</h6>
                                            </th>
                                            <th class="border-bottom-0">
                                        ...
                                        @if ($subCategories->isNotEmpty())
                                            @foreach ( $subCategories as $subCategory )
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="border-bottom-0"> <h6 class="fw-semibold mb-0">{{$subCategory->categoryName}}</h6> </td>
                                                    <td class="border-bottom-0"><h6 class="fw-semibold mb-0">{{$subCategory->name}}</h6></td>
                                                    <td class="border-bottom-0"><h6 class="fw-semibold mb-0">{{$subCategory->slug}}</h6></td>
    ...
    @section('customJS')
        <script type="text/javascript">         
            function deleteSubCategory(id) {
                var url = "{{route('admin.subcategories.delete', 'ID')}}";
                var newUrl = url.replace("ID",id);
                
                if(confirm("Estas seguro que quieres eliminar esta subcategoria?")){
                    $.ajax({
                        url: newUrl,
