                ...
                <div class="col-lg-12 d-flex align-items-stretch">
                    <div class="card w-100">
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-6">
                                    <small> SUB-CATEGORIAS / EDITA  </small>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <form action="" id="subCategoryForm" name="subCategoryForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="categoryfather" class="form-control" id="categoryfather" aria-describedby="statusHelp">
                                            <option value="">Selecciona una categoria padre:</option>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" id="subcategoryname" aria-describedby="categoryHelp" value="{{$subCategory->name}}">
                                        <p></p>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="slug" class="form-control" id="subcategoryslug" aria-describedby="slugHelp" readonly value="{{$subCategory->slug}}">
                                        <p></p>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="status" class="form-control" id="subcategorystatus" aria-describedby="statusHelp">
                                            <option {{($subCategory->status == 1) ? 'selected' : ''}} value="1">Activa</option>
                                            <option {{($subCategory->status == 0) ? 'selected' : ''}} value="0">Bloqueada</option>
                                        </select>
